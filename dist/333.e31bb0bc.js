...
module.exports = [{
  ...
  "price": 100,
  "ingredients": ["Тыква", "Петрушка", "Сливки", "Бренди", "Куриный бульон", "Картофель"]
}, {
  "id": "k2k0UrjZG",
  ...
  "price": 350,
  "ingredients": ["Оливковое масло", "Лимонный сок", "Чеснок", "Помидоры", "Красный лук", "Сыр фета"]
}, {
  "id": "X2aQ7cvkd",
  ...
  "price": 170,
  "ingredients": ["Сливочное масло", "Пшеничная мука", "Голубика", "Ванильный экстракт", "Мускатный орех", "Картофель"]
}, {
  "id": "nk3zy1pf8",
  ...
  "price": 270,
  "ingredients": ["Говядина", "Соленые огурцы", "Картофель", "Мясной бульон", "Чеснок", "Картофель"]
}, {
  "id": "b7k2U13fd",
...
function createCards() {
  return _menu.default.map(function (e) {
    return "\n        <li class=\"menu__item\">\n      <article class=\"card\">\n        <img\n          src= \"".concat(e.image, "\"\n          alt=\"").concat(e.name, "\"\n          class=\"card__image\"\n        />\n        <div class=\"card__content\">\n          <h2 class=\"card__name\">").concat(e.name, "</h2>\n          <p class=\"card__price\">\n            <i class=\"material-icons\"> monetization_on </i>\n            ").concat(e.price, " \u043A\u0440\u0435\u0434\u0438\u0442\u043E\u0432\n          </p>\n    \n          <p class=\"card__descr\">\n          ").concat(e.description, "\n          </p>\n    \n          <ul class=\"tag-list\">\n            <li class=\"tag-list__item\">").concat(e.ingredients[0], "</li>\n            <li class=\"tag-list__item\">").concat(e.ingredients[1], "</li>\n            <li class=\"tag-list__item\">").concat(e.ingredients[2], "</li>\n            <li class=\"tag-list__item\">").concat(e.ingredients[3], "</li>\n            <li class=\"tag-list__item\">").concat(e.ingredients[4], "</li>\n            <li class=\"tag-list__item\">").concat(e.ingredients[5], "</li>\n          </ul>\n        </div>\n    \n        <button class=\"card__button button\">\n          <i class=\"material-icons button__icon\"> shopping_cart </i>\n          \u0412 \u043A\u043E\u0440\u0437\u0438\u043D\u0443\n        </button>\n      </article>\n    </li>\n        ");
  }).join('');
}
...
function writesLocalStorage() {
  var currentTopic = document.querySelector('body').className;
  localStorage.setItem('currentTopic', currentTopic);
}

;
var currentClassValue = localStorage.getItem('currentTopic');
document.body.classList.toggle(currentClassValue);

function changesCheckboxValue() {
...
//# sourceMappingURL=/333.e31bb0bc.js.map